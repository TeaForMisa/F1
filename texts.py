...
PRO_PITCH = (
    "⭐ <b>F1 Bot Pro</b>\n\n"
    "Бот полностью бесплатный, и так и останется - расписание, зачёты и "
    "уведомления никуда не денутся и ничего не урезано.\n\n"
    "Если хочешь поддержать разработку, Pro даёт немного приятных бонусов "
    "сверху:\n\n"
    "🏁 <b>Результаты сессий</b>\n"
    "Итоги квалификаций, спринтов и гонок - сразу как опубликованы.\n\n"
    "🏎 <b>Избранный пилот</b>\n"
    "Его место подсвечивается в результатах отдельной строкой.\n\n"
    "⏰ <b>Ещё два напоминания</b>\n"
    "«За 1 день» и «за 10 минут» - в дополнение к основным трём.\n\n"
    "▬▬▬▬▬▬▬▬▬▬\n\n"
    "💛 <b>{price} ⭐ за 30 дней.</b>\n"
    "Без автопродления - звёзды спишутся один раз, доступ тихо закончится "
    "сам. Захочешь продолжить - просто оформи ещё раз."
)

PRO_ACTIVE = (
    "⭐ <b>F1 Bot Pro активен</b>\n\n"
    "Действует до: <b>{until}</b>\n"
    "(без автопродления - по истечении просто оформи заново)\n\n"
...
PRO_PAID = (
    ...
    "F1 Bot Pro активен на 30 дней (без автопродления).\n"
